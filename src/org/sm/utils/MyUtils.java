...
public class MyUtils 
{
	...
	/**
	 * Store Connectiion in request attribute
	...
	{
		session.setAttribute("loginedUser", loginedUser); 	//on the jsp can access via ${loginedUser} 
	}
	
	//Get the user information stored inthe session
